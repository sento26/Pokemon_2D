...
Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using Solace Vision.
...
- __Application__ means the software program provided by the Company downloaded by You to a Device, named Solace Vision


- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Solace Vision Inc., 420 E. Archer St, Apt. 537, Tulsa OK 74120.
...
- __Country__ refers to: Oklahoma,  United States
...
- By email: general@solacevision.com